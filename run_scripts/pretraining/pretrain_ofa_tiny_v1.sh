...
#SBATCH --gres=gpu:geforce_rtx_3090:4   # titan_rtx & geforce_rtx_3090 & tesla_v100 & geforce_rtx_2080_ti & rtx_a6000
...
data_dir=/itet-stor/xzheng/net_scratch/workflow/MedVLM
